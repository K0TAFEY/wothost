<?php 
	...
	$clientScript->registerCoreScript('font-awesome');
	$clientScript->registerCoreScript('simple-line-icons');
	$clientScript->registerCoreScript('bootstrap');
	$clientScript->registerCoreScript('uniform');
	$clientScript->registerCoreScript('jquery-migrate');
	$clientScript->registerCoreScript('jquery-blockui');
	$clientScript->registerCoreScript('jquery-slimscroll');
	$clientScript->registerCoreScript('bootstrap-hover-dropdown');
?>
...
<head>
<meta charset="utf-8"/>
<title>Conquer | Page Layouts - Boxed Page</title>
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<div class="theme-panel hidden-xs hidden-sm">
					...
					<div class="theme-options">
						...
						<div class="theme-option">
							<span>
							Layout </span>
							<select class="layout-option form-control input-small" disabled="">
				...
				<!-- BEGIN PAGE HEADER-->
				<h3 class="page-title">
				Boxed Page <small>boxed layout</small>
				</h3>
				<div class="page-bar">
